import { CrossSubpageNavigatorLink } from "../navigation/CrossSubpageNavigatorLink";
...
export function HeaderSmall({ title }: Readonly<{ title: string }>) {
  return (
    <header className="grid grid-cols-1 grid-rows-1">
      ...
      <nav className="m-2 text-white fill-white row-start-1 row-end-1 col-start-1 col-end-1">
        <CrossSubpageNavigatorLink name="Home" href="/" direction="home"/>
      </nav>
